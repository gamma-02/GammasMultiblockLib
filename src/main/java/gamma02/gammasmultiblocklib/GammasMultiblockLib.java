...
public class GammasMultiblockLib implements ModInitializer {
     ...
     */
    public static ArrayDeque<Pair<Pair<Function<Pair<World, MultiblockController>, Multiblock>, Pair<World, MultiblockController>>, Pair<MultiblockController, Long>>> multiblockRecognizationQueue = new ArrayDeque<>();
     ...
     * @param function xa function that takes a World and gives a Multiblock, this should be your multiblock's {@link MultiblockController#searchForMultiblock()} method. CALL IN THE SERVER!!! gamma <3
     ...
     */
    public static void addToRecognizationThread(Function<Pair<World, MultiblockController>, Multiblock> function, World world,  MultiblockController controller){
//        multiblockRecognizationQueue.add(new Pair<Pair<Function<Pair<World, MultiblockController>, Multiblock>, Pair<World, MultiblockController>>, Pair<MultiblockController, Long>>(new Pair<Function<Pair<World, MultiblockController>, Multiblock>, Pair<World, MultiblockController>>(function, new Pair<World, MultiblockController>(world, controller)), new Pair<MultiblockController, Long>(controller, System.currentTimeMillis())));
        DETECTION_THREAD.addToQueue(new Pair<Pair<Function<Pair<World, MultiblockController>, Multiblock>, Pair<World, MultiblockController>>, Pair<MultiblockController, Long>>(new Pair<Function<Pair<World, MultiblockController>, Multiblock>, Pair<World, MultiblockController>>(function, new Pair<World, MultiblockController>(world, controller)), new Pair<MultiblockController, Long>(controller, System.currentTimeMillis())));
